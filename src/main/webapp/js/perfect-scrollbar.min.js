...
(function(e) {
    ...
    e.fn.perfectScrollbar = function(n, i) {
        return this.each(function() {
            ...
            var E, D, C, Y, X, k, W, I, O, R, j, A, B = "rtl" = css\ 1 _ === M.css("direction"),
                K = r(),
                q = this.ownerDocument || document,
                H = e("<div class='ps-scrollbar-x-rail'>").appendTo(M),
                U = e("<div class='ps-scrollbar-x'>").appendTo(H),
                _ = t(css\ 2 _(H.css("bottom")), N = _ === _, Q = N ? null : t(css\ 3 _(H.css("top")), z = t(css\ 4 _(H.css("borderLeftWidth")) + t(css\ 5 _(H.css("borderRightWidth")), F = t(css\ 6 _(H.css("marginLeft")) + t(css\ 7 _(H.css("marginRight")), G = e("<div class='ps-scrollbar-y-rail'>").appendTo(M), J = e("<div class='ps-scrollbar-y'>").appendTo(G), V = t(css\ 8 _(G.css("right")), Z = V === V, $ = Z ? null : t(css\ 9 _(G.css("left")), et = t(css\ 10 _(G.css("borderTopWidth")) + t(css\ 11 _(G.css("borderBottomWidth")), tt = t(css\ 12 _(G.css("marginTop")) + t(css\ 13 _(G.css("marginBottom")), ot = "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch, nt = null !== window.navigator.msMaxTouchPoints;
            return S(), M
        })
    }
});