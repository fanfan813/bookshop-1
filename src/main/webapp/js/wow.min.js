...
(function() {
    ...
    b = function() {
        ...
        function a() {
            console.warn("MutationObserver is not supported by your browser."), console.warn("css\1_WOW.js cannot detect dom mutations, please call .sync() after loading new content.")
        }
